...
(function () {
    ...
    exportModule("data-context-binding", ["data-context"], function factory(DC) {
        ...
        var { createDataContext, parse, parsePromise, stringify } = DC;
        ...
        var DataContextBinding = Object.defineProperties(bindDataContext, {
            ...
            change: { value: change, writable: false, configurable: false, enumerable: false },
        ...
        */
        function bindDataContext(value) {
            ...
            if (htmlElement.dataContext) {
                ...
                if (value !== undefined) {
                    ...
                    setTimeout(bindAllElements, 0, htmlElement, true);
                }
            }
            else if (value = document.querySelector("script#data")?.innerText) {

                htmlElement.dataContext = createDataContext(value && parse(value) || {});
                setTimeout(bindAllElements, 0, htmlElement);
            }
            //else {
        ...
        function checkBind(event) {
            ...
            this.checked = event.eventName;
            event.eventName ? this.setAttribute("checked", "") : this.removeAttribute("checked");
        ...
        if (typeof exports === 'object' && typeof module !== 'undefined') {
            ...
            if (importIdentifierArray.length) {
                ...
                for (let i = 0; i < importIdentifierArray.length; i++) {
                    ...
                    thisScope.modules[importIdentifierArray[i]] = require(importIdentifierArray[i]);
                }
            }

            return module.exports = factory.call(thisScope, ...importIdentifierArray.map(function (id) { return thisScope.modules[id]; }));
        }
